		...
		computed: {
			...
			inputContentStyle() {
				...
				return obj2strStyle({
					...
					'background-color': this.disabled ? this.styles.disableColor : '#f6f7f9'
				})
			},
			// input右侧样式
			inputStyle() {
				const paddingRight = this.type === 'password' || this.clearable || this.prefixIcon ? '' : '0px'
				return obj2strStyle({
					'padding-right': paddingRight,
					'padding-left': this.prefixIcon ? '' : '0px'
				})
			}
		},
		watch: {
